    ...
    <nav class="bg-[#7D0A0A]  text-white fixed top-0 left-0 w-full z-50 shadow-md" x-data="{ open: false, openProfil: false }">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:flex space-x-6 px-6 text-white py-4 font-bebas text-lg tracking-wide uppercase">
                ...
                <!-- Profil Dropdown -->
                <div class="relative" x-data="{ open: false, timeout: null }" @mouseenter="clearTimeout(timeout); open = true"
                    ...
                    <ul x-show="open" x-transition x-cloak
                        ...
                        <li><a href="/guru" class="flex items-center gap-2 px-4 py-2 hover:bg-[#FFEC9E] rounded-xl"><i
                                    class="fas fa-chalkboard-teacher"></i> Profil Guru</a></li>
                        <li><a href="/siswa" class="flex items-center gap-2 px-4 py-2 hover:bg-[#FFEC9E] rounded-xl"><i
            ...
            <div>
                <button @click="openProfil = !openProfil"
                    ...
                    <svg class="h-4 w-4 transform transition-transform duration-300 ease-in-out"
                        :class="{ 'rotate-180': openProfil }" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
