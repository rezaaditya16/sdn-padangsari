...
@section('content')
<div class="mb-6">
    <h2 class="text-3xl font-bold text-gray-800 mb-2">Dashboard Wali Kelas</h2>
    <p class="text-gray-600">Kelola pengaduan yang terkait dengan kelas dan siswa binaan</p>
</div>

<!-- Statistics Cards -->
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="bg-gradient-to-r from-teal-400 to-cyan-500 text-white p-6 rounded-lg shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-teal-100 text-sm font-medium">Total Pengaduan</p>
                <p class="text-3xl font-bold">{{ $stats['total'] }}</p>
            </div>
            <i class="fas fa-chalkboard-teacher text-3xl text-teal-200"></i>
        </div>
    </div>
...
<div class="bg-white rounded-lg shadow-lg overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-xl font-semibold text-gray-800">Pengaduan Siswa Kelas</h3>
        <p class="text-sm text-gray-600 mt-1">Pengaduan dari siswa dalam kelas yang Anda bina</p>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                        Belum ada pengaduan dari siswa kelas Anda.
                    </td>
                </tr>
                @endforelse
            </tbody>
