...
@section('content')
<div class="mb-6">
    <h2 class="text-3xl font-bold text-gray-800 mb-2">Dashboard Tenaga Pendidik</h2>
    <p class="text-gray-600">Kelola pengaduan terkait fasilitas dan administrasi sekolah</p>
</div>

<!-- Statistics Cards -->
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="bg-gradient-to-r from-orange-400 to-red-500 text-white p-6 rounded-lg shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-orange-100 text-sm font-medium">Total Pengaduan</p>
...
<div class="bg-white rounded-lg shadow-lg overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-xl font-semibold text-gray-800">Pengaduan Fasilitas & Administrasi</h3>
        <p class="text-sm text-gray-600 mt-1">Pengaduan terkait fasilitas sekolah dan administrasi</p>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                        Belum ada pengaduan terkait fasilitas dan administrasi.
                    </td>
                </tr>
                @endforelse
            </tbody>
